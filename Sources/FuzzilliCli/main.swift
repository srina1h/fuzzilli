...
func makeFuzzer(with configuration: Configuration) -> Fuzzer {
    ...
    var mutators = WeightedList([
        ...
        // (FixupMutator()),                   1),
        // (ReplaceQuitInToPrimitiveMutator(), 1),
        ...
        // (SpeculativeNumberIndexingCircumventionMutator(), 1),
        // (ReplaceFunctionConstructorMutator(), 1),
        // (FixPromiseResolveReassignmentMutator(), 1),
        // (SpecificDateTimeCrashFixer(), 1),
        ...
        // (FixIifeLoopUpdateMutator(), 1),
        // (SpecificStencilLazinessStringMutator(), 1),
        // (OomTestOffThreadCompileStencilFixMutator(), 1),
        // (SpecificCrashReproducerMutator(), 1),
        // (SpiderMonkeyDebuggerCreateSourceMutator(), 1),
        // (FixDumpStencilLineNumberMutator(), 1),
        // (OomEvalIifeToGeneratorMutator(), 1),
        // (SpiderMonkeySpecificSearchUndefinedMutator(), 1),
        // (DiscardSourceMutator(), 1),
        // (MoveStackAccessBeforeNukeCCWsMutator(), 1),
        // (SpecificUtf8DecodingFixMutator(), 1),
        // (SpecificCrashTransformerMutator(), 1),
        // (CrossRealmCallCircumventionMutator(), 1),
        // (FixDebuggerThrowArgumentMutator(), 1),
        // (MakeSerializableLogCrashFixerMutator(), 1),
        // (RestParameterCircumventionMutator(), 1),
        // (DebuggerCallbackFixMutator(), 1),
        // (SpecificCodePointAtMutator(), 1),
        // (WeakMapSymbolToObjectKeySwapMutator(), 1),
        // (SpecificEvalInWorkerCircumventionMutator(), 1),
        // (SpecificSpiderMonkeyCrashMutator(), 1),
        // (ForInToForLoopMutator(), 1),
        // (EnsureNonInlineCreatorFixMutator(), 1),
        // (SpiderMonkey9137f8FixMutator(), 1),
        // (RemoveGczealMutator(), 1),
        ...
        // (SpecificCrashFixMutator(), 1),
        // (DebuggerPrivateStaticGetterCrashFixMutator(), 1),
        // (ShadowRealmInterruptFixMutator(), 1),
        // (ReflectApplyToDirectCallMutator(), 1),
        // (WasmInstantiateStreamingToInstantiateMutator(), 1),
        // (FixToStringRadixMutator(), 1),
        // (CircumventToStringBaseOptMutator(), 1),
        // (DynamicToStaticImportMapMutator(), 1),
        // (SpecificCrashMutator(), 1),
        // (ReplaceEmptySwitchInElseMutator(), 1),
        // (RemoveRevokeCallMutator(), 1),
        // (SerializeMutator(), 1),
